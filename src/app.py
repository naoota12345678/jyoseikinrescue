...
4. データベースに記載されていない詳細な金額は記載せず、「詳細は厚生労働省にお問い合わせください」と回答してください
5. 具体的な金額を推測・補完・創作してはいけません
6. データベースに記載された通りの表現のみを使用してください
...
以下の企業情報を基に、上記の正確なデータベース情報のみを使用して、該当する可能性のある助成金をすべて判定してください。
...
- 業務改善助成金：データベースに記載されている通りの助成率・上限額のみを記載し、具体的な金額は推測しない
...
■ 年齢関連
- 50歳以上 → 特定求職者雇用開発助成金（生涯現役コース）、65歳超雇用推進助成金の検討対象
- 60-64歳 → 65歳超雇用推進助成金、エイジフレンドリー補助金を必ず記載
- 65歳以上 → 65歳超雇用推進助成金を最優先、エイジフレンドリー補助金を必ず記載
- 継続雇用制度 → 65歳超雇用推進助成金を最優先表示

■ 雇用形態関連
- 有期契約労働者 → キャリアアップ助成金正社員化コースを必ず記載
- 非正規雇用 → キャリアアップ助成金全コースを網羅的に記載
- パート・アルバイト → トライアル雇用助成金も検討

■ 特別な労働者
- 障害者雇用 → 特定求職者雇用開発助成金＋障害者関係8助成金すべて記載
- 母子家庭等 → 特定求職者雇用開発助成金、トライアル雇用を記載
...
■ 設備投資・改善
- 設備投資全般 → 業務改善助成金全コース必ず記載
- IT・デジタル化 → IT導入補助金、ものづくり補助金を記載
- 受動喫煙対策 → 受動喫煙防止対策助成金を記載
- 安全設備 → 高度安全機械等導入支援補助金、エイジフレンドリー補助金

■ 人材育成
- 研修・教育訓練 → 人材開発支援助成金必ず記載
- 資格取得支援 → 人材開発支援助成金を最優先
- 教育訓練休暇 → 教育訓練休暇等付与コースを記載

■ 働き方改革
- 時間外労働削減 → 働き方改革推進支援助成金必ず記載
